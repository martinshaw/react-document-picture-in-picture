...
`}
      ...
      <p className="subtle-text">
        There are a few useful event props which you can use to listen to the
        state of the Picture in Picture window: <code>onOpen</code>,{" "}
        <code>onClose</code>, <code>onResize</code>
        <br />
        <br />
