...
`}
            ...
            <div className="button-bar">
                <ReactDocumentPictureInPicture
                    buttonRenderer={({ open }) => <button className="button" onClick={open}>Open Unstyled</button>}
                >
                    <div>
                        <i>This window should not be styled with the styles from the main window</i>
