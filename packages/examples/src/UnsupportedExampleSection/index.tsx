...
`}
            ...
            <p className="subtle-text">
                View this page in a browser such as Safari or Firefox and you will see <code>Feature Unavailable: API_NOT_SUPPORTED</code> rendered in place of the activating button.
                <br/><br/>
                Attempt to use this component on a website not served over HTTPS and you will see <code>Feature Unavailable: USING_UNSECURE_PROTOCOL</code> rendered in place of the activating button.
                <br/><br/>
                Without the <code>featureUnavailableRenderer</code> prop, the component will quietly render nothing when the feature is unavailable.
            </p>
