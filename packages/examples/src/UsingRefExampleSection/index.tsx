import ReactDocumentPictureInPicture, {
  type ReactDocumentPictureInPictureForwardRefType,
} from "react-document-picture-in-picture";
...
`}
      ...
      >
        <i>
          This text should be displayed in a Document Picture in Picture in the
          bottom right of the original window
        </i>
      </ReactDocumentPictureInPicture>
    </div>
  );
